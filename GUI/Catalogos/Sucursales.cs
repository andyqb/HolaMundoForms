...
namespace HolaMundoForms.Catalogos
{
    public partial class Sucursales : Form
    {
        ...
        private void resp_TextChanged(object sender, EventArgs e)
        {
        ...
        private void codigosuc_ValueChanged(object sender, EventArgs e)
        {

        }

        private void nombresuc_TextChanged(object sender, EventArgs e)
        {
