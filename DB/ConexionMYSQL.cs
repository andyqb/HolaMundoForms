...
namespace Holamundoforms.BD
{
    class ConexionMYSQL
    {
        ...
        public string MYSQL_CONEXION_NET = "Server=localhost; User ID=andy; Password=root;" + "Persist Security info=true; Database=ppatolin";

        public string MYSQL_CONEXION_ODBC = "Driver={MySQL ODBC 5.3}; Server=localhost;" + "User=vendedor; Password=vendedor; Database=ppatolin;" + "Opcion=3;";
